...
public class ModItems {
    ...
    public static final Item SAPPHIRE_SABER = registerItem("sapphire_saber", new SaberItem(ModToolMaterials.SAPPHIRE,3,-2.4f,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1), ModParticles.BLUE_SWEEP_PARTICLE,ModParticles.BLUE_CRIT_PARTICLE));

    public static final Item RUBY = registerItem("ruby",new Item(new FabricItemSettings().maxCount(16).fireproof().rarity(Rarity.UNCOMMON)));
    public static final Item RUBY_SABER = registerItem("ruby_saber", new SaberItem(ModToolMaterials.RUBY,3,-2.4f,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1), ModParticles.RED_SWEEP_PARTICLE,ModParticles.RED_CRIT_PARTICLE));
    public static final Item RUBY_SWORD = registerItem("ruby_sword", new SwordItem(ModToolMaterials.RUBY,3,-2.4f,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_PICKAXE = registerItem("ruby_pickaxe", new PickaxeItem(ModToolMaterials.RUBY,1,-2.8f,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_AXE = registerItem("ruby_axe", new AxeItem(ModToolMaterials.RUBY,6,-3.1f,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_SHOVEL = registerItem("ruby_shovel", new ShovelItem(ModToolMaterials.RUBY,3,-2.4f,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_HOE = registerItem("ruby_hoe", new HoeItem(ModToolMaterials.RUBY,-2,-1.0f,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    ...
    public static final Item RUBY_HELMET = registerItem("ruby_helmet", new ArmorItem(ModArmorMaterials.RUBY, ArmorItem.Type.HELMET,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_CHESTPLATE = registerItem("ruby_chestplate", new ArmorItem(ModArmorMaterials.RUBY, ArmorItem.Type.CHESTPLATE,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_LEGGINGS = registerItem("ruby_leggings", new ArmorItem(ModArmorMaterials.RUBY, ArmorItem.Type.LEGGINGS,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_BOOTS = registerItem("ruby_boots", new ArmorItem(ModArmorMaterials.RUBY, ArmorItem.Type.BOOTS,new FabricItemSettings().rarity(Rarity.UNCOMMON).maxCount(1)));
