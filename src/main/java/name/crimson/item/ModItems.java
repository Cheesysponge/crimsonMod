...
public class ModItems {
    ...
    public static final Item SAPPHIRE_SWORD = registerItem("sapphire_sword", new SwordItem(ModToolMaterials.SAPPHIRE,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item SAPPHIRE_PICKAXE = registerItem("sapphire_pickaxe", new PickaxeItem(ModToolMaterials.SAPPHIRE,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item SAPPHIRE_AXE = registerItem("sapphire_axe", new AxeItem(ModToolMaterials.SAPPHIRE,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item SAPPHIRE_SHOVEL = registerItem("sapphire_shovel", new ShovelItem(ModToolMaterials.SAPPHIRE,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item SAPPHIRE_HOE = registerItem("sapphire_hoe", new HoeItem(ModToolMaterials.SAPPHIRE,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item SAPPHIRE_SABER = registerItem("sapphire_saber", new SaberItem(ModToolMaterials.SAPPHIRE,3,-2.4f,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1), ModParticles.BLUE_SWEEP_PARTICLE,ModParticles.BLUE_CRIT_PARTICLE));

    public static final Item RUBY = registerItem("ruby",new Item(new Item.Settings().maxCount(16).fireproof().rarity(Rarity.UNCOMMON)));
    public static final Item RUBY_SABER = registerItem("ruby_saber", new SaberItem(ModToolMaterials.RUBY,3,-2.4f,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1), ModParticles.RED_SWEEP_PARTICLE,ModParticles.RED_CRIT_PARTICLE));
    public static final Item RUBY_SWORD = registerItem("ruby_sword", new SwordItem(ModToolMaterials.RUBY,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_PICKAXE = registerItem("ruby_pickaxe", new PickaxeItem(ModToolMaterials.RUBY,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_AXE = registerItem("ruby_axe", new AxeItem(ModToolMaterials.RUBY,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_SHOVEL = registerItem("ruby_shovel", new ShovelItem(ModToolMaterials.RUBY,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
    public static final Item RUBY_HOE = registerItem("ruby_hoe", new HoeItem(ModToolMaterials.RUBY,new Item.Settings().rarity(Rarity.UNCOMMON).maxCount(1)));
