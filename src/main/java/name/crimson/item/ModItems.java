...
public class ModItems {
    ...
    public static final Item[] items = new Item[] {CHOMPER_SPAWN_EGG,CRIMSON_EYE, TIGER_SPAWN_EGG, NETHER_WART_BREAD, SAPPHIRE};
    public static final Item[] items_for_textures = new Item[] {CRIMSON_EYE, NETHER_WART_BREAD, SAPPHIRE};
