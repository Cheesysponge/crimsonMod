...
public class ModLootTableGenerator extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.NETHER_RUBY_ORE, dropsWithSilkTouch(ModBlocks.NETHER_RUBY_ORE, this.applyExplosionDecay(ModBlocks.NETHER_RUBY_ORE, ItemEntry.builder(ModItems.RUBY).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1F, 2.0F))).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE)))));
