package name.crimson.block.custom.item;
...
public class ToolBlockItem extends BlockItem{

    private final ToolMaterial material;

    public ToolBlockItem(Block block, Settings settings, ToolMaterial material) {
        super(block, settings.maxDamage(material.getDurability()).component(DataComponentTypes.TOOL, createToolComponent()));
